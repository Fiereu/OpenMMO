...
/**
 * Delegator for ByteBuf.
 * This class is used to extend ByteBuf with additional methods.
 * It wraps an existing ByteBuf and delegates all method calls to it.
 * @see ByteBuf
 */
public abstract class ByteBufDelegator extends ByteBuf {
  private final ByteBuf delegate;
  
  public ByteBufDelegator(ByteBuf delegate) {
    this.delegate = delegate;
  }

  public ByteBufDelegator(ByteBufDelegator delegate) {

...
public class Inventory extends TableImpl<InventoryRecord> {
     ...
     */
    public final TableField<InventoryRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>public.inventory.name</code>.
     */
    public final TableField<InventoryRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(32).nullable(false), this, "");
    ...
    public List<UniqueKey<InventoryRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.INVENTORY_NAME_KEY);
    }
    ...
    public OwnedItemPath ownedItem() {
        if (_ownedItem == null)
            _ownedItem = new OwnedItemPath(this, null, Keys.OWNED_ITEM__OWNED_ITEM_INVENTORY_ID_FKEY.getInverseKey());

...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, String> USERNAME = createField(DSL.name("username"), SQLDataType.VARCHAR(12).nullable(false), this, "");

    /**
     * The column <code>public.user.password</code>.
     */
    public final TableField<UserRecord, byte[]> PASSWORD = createField(DSL.name("password"), SQLDataType.BLOB.nullable(false), this, "");
    ...
    public CharacterPath character() {
        if (_character == null)
            _character = new CharacterPath(this, null, Keys.CHARACTER__CHARACTER_USER_ID_FKEY.getInverseKey());
    ...
    public ServerTokenPath serverToken() {
        if (_serverToken == null)
            _serverToken = new ServerTokenPath(this, null, Keys.SERVER_TOKEN__SERVER_TOKEN_USER_ID_FKEY.getInverseKey());
    ...
    public UserPermissionPath userPermission() {
        if (_userPermission == null)
            _userPermission = new UserPermissionPath(this, null, Keys.USER_PERMISSION__USER_PERMISSION_USER_ID_FKEY.getInverseKey());
